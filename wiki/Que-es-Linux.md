...
* **Tiling Window Managers (Administradores de ventana de tipo mosaico)**: Administran la posición y tamaño de las ventanas por tí, su objetivo es que uses el 100% de tu pantalla sin importar cuáles o cuántas ventanas tengas abiertas al mismo tiempo, además de <u>ser más rapidos consumir menos recursos</u>.
* **Floating Window Managers (Administradores de ventana de tipo flotante)**: Las ventanas flotan una sobre otras, el administrador de ventanas de Windows y MacOS es de este tipo, por lo que ya estarás familiarizado sobre su funcionamiento.
